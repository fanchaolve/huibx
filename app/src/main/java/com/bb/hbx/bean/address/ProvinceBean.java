...
public class ProvinceBean {
    ...
    private List<AddressBean.AreasListBean.ChildrenBeanX> children;
    ...
    public List<AddressBean.AreasListBean.ChildrenBeanX> getChildren() {
        return children;
    }

    public void setChildren(List<AddressBean.AreasListBean.ChildrenBeanX> children) {
    ...
    public static class ChildrenBeanX {
        ...
        private int areaId;
        private String areaName;
        private List<AddressBean.AreasListBean.ChildrenBeanX.ChildrenBean> children;
        ...
        public List<AddressBean.AreasListBean.ChildrenBeanX.ChildrenBean> getChildren() {
            return children;
        }

        public void setChildren(List<AddressBean.AreasListBean.ChildrenBeanX.ChildrenBean> children) {
            this.children = children;
        }
